...
var InstructionsPreference = new Instructions(
    ...
    var InstructionsWriteLesson = new Instructions(
      ...
      "Also important, the options they will have to choose from will have the same value a yours, but they will be represented by different symbols, so <b>focus on the concepts and strategies rather than one concrete symbol's shape or color</b>, since they wont be the same anyways. ",
