  ...
  $('#ContBox').html(c_Stage+c_FinalButton);
	...
	sendToDB(0,
      ...
      var EndText ='<div class="col"><h3 align = "center"> <br> You have made it to the end of the experiment!</h3>  ' +
                  ...
                  '<p align = "center" > You will receive the full designated fixed compensation of 3 pounds/hour. Additionally, during the task, <b> you won points equivalent to &pound ' + points2pounds(rew,exp.rate) +'  </b> </p>' +
                  // '<p align = "center" ><b> You won ' + rew +' points! </b></p>' +
