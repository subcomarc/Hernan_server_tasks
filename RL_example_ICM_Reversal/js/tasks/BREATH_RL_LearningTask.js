...
function recordResponse() {
  ...
  rs.push({
    partID: exp.ID,
      ...
      ContextType:String('SymbolA_'+track.symbolA.prob+'prob'+track.symbolA.reward+'rew'+'_vs_'+'SymbolB_'+track.symbolB.prob+'prob'+track.symbolB.reward+'rew')
  })
