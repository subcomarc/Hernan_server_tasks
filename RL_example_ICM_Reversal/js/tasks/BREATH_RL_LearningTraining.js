...
var BREATH_RL_LearningTraining = {
...
export{BREATH_RL_LearningTraining}
...
if(track.trial==(ts.maxTrials)){endTask(track.tRew,0); return}
...
function recordResponse() {
  ...
  // SendtoDB(track.trial)
    sendToDB(0,rs[track.trial],'php/InsertDB_Training.php');
